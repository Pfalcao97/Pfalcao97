...
My day job is as a **Data Enginner**, at an brazilian education company, [Descomplica](https://descomplica.com.br/). I work daily with **Python**, **SQL**, **GCP**, **Bash**, **Docker**, **Airflow** and **UNIX systems**.<br> I'm also learning **Rust** on my free time, so that could <br> pop off now and again over here! <br>
